...
var statusByCode = map[ErrorCode]int{
	...
	CodeBookingSlotUnavailable:        http.StatusConflict,
	CodeBookingNotFound:               http.StatusNotFound,
	CodeBookingInvalidTransition:      http.StatusConflict,
	CodeOAuthStateInvalid:             http.StatusBadRequest,
	CodeOAuthDenied:                   http.StatusUnauthorized,
	CodeOAuthExchangeFailed:           http.StatusBadGateway,
	CodeOAuthInvalidIdentityToken:     http.StatusUnauthorized,
	CodeOAuthEmailUnverified:          http.StatusForbidden,
	CodeExternalIdentityConflict:      http.StatusConflict,
...
var publicMessageByCode = map[ErrorCode]string{
	...
	CodeServiceNotFound:               "The requested service was not found.",
	CodeStaffNotFound:                 "The requested staff profile was not found.",
	CodeCategoryNotFound:              "The requested service category was not found.",
	CodeImageNotFound:                 "The requested service image was not found.",
	CodeTenantSlugTaken:               "The tenant slug is already taken.",
	CodeTenantSlugInvalid:             "The tenant slug is not valid.",
	...
	CodeBookingSlotUnavailable:        "That time is no longer available. Please choose another time.",
	CodeBookingNotFound:               "The requested booking was not found.",
	CodeBookingInvalidTransition:      "This booking cannot make that transition right now.",
	CodeOAuthStateInvalid:             "The sign-in request expired or was invalid. Please try again.",
	CodeOAuthDenied:                   "Sign-in with Google was cancelled.",
	CodeOAuthExchangeFailed:           "Could not complete sign-in with Google. Please try again.",
	CodeOAuthInvalidIdentityToken:     "Could not verify your Google identity. Please try again.",
	CodeOAuthEmailUnverified:          "Your Google email address is not verified.",
	CodeExternalIdentityConflict:      "That Google account is already linked to another user.",
